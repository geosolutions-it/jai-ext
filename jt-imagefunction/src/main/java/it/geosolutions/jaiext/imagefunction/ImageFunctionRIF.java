...
/**
 * {@link RenderedImageFactory} implementation generating a
 * {@link ImageFunctionOpImage} instance.
 * 
...
public class ImageFunctionRIF implements RenderedImageFactory {
	...
	public RenderedImage create(ParameterBlock paramBlock,
		...
		return new ImageFunctionOpImage(function, minX, minY, width, height,
				xScale, yScale, xTrans, yTrans, roi, nodata, destNoData,
				renderHints, layout);
	}
