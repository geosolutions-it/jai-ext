...
public class ClampTest extends TestBase {
    /** Logger */
    private Logger logger = Logger.getLogger(ClampDescriptor.class.getName());
                    ...
                    for (int y = minY; y <= maxY; y++) {
                        ...
                        if (isValidRoi) {
                            ...
                            for (int b = 0; b < dstBands; b++) {
                                ...
                                if (nodataUsed && samplenodata) {
                                    assertEquals(result, destNoData, TOLERANCE);
                                    ;
                                } else {
                                    if (result < low[b] || result > high[b])
                                        valid = false;
                                }
