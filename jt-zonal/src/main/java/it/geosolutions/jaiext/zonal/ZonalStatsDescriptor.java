...
public class ZonalStatsDescriptor extends OperationDescriptorImpl {
    ...
    private static final Class[] paramClasses = { RenderedImage.class, AffineTransform.class, java.util.List.class,
    ...
    private static final String[] paramNames = {"classifier", "transform", "roilist", "ROI", "noData",
            "useRoiAccessor", "bands", "stats" };

    /** The parameter default value list for this operation. */
    private static final Object[] paramDefaults = { null, null, null, null, null, false, new int[] { 0 },
            null };
