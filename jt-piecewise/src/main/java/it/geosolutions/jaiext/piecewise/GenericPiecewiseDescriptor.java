...
public class GenericPiecewiseDescriptor extends OperationDescriptorImpl {
		...
		super(new String[][] {
				...
				new Class[] { DefaultPiecewiseTransform1D.class, Integer.class,
						...
						it.geosolutions.jaiext.range.Range.class }, // Argument
																	// classes
				new Object[] { NO_PARAMETER_DEFAULT, new Integer(-1), null,
						null }, // Default values for parameters,
				null // No restriction on valid parameter values.
		);
	}

	public RenderedOp create(RenderedImage source0,
			DefaultPiecewiseTransform1D domain1D, Integer bandIndex, ROI roi,
	 ...
	 * check that the number of bands in the source image is equals to the
	 * number of supplied sample dimensions, and that all sample dimensions has
	 * piecewise.
	 * 
	 * @param modeName
	...
	protected boolean validateParameters(final String modeName,
		...
		final PiecewiseTransform1D lic = (PiecewiseTransform1D) param
