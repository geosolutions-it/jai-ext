...
class PiecewiseUtilities {
    ...
    static void domainElementsOverlap(DomainElement1D[] domainElements, int idx) {
        ...
        final Comparable[] args = new Comparable[] { range1.getMinValue(), range1.getMaxValue(),
    ...
    public static boolean equals(it.geosolutions.jaiext.piecewise.MathTransformation inverse,
