...
Current release is [**1.0.1**](http://demo.geo-solutions.it/share/github/jai-ext/releases/1.0.X/1.0.1/). More informations about the releases can be found [here](https://github.com/geosolutions-it/jai-ext/wiki/Releases).
