...
public class AffineDescriptor extends OperationDescriptorImpl {
    ...
    public static final boolean register() {
        ...
        try {
            final OperationDescriptor op = new AffineDescriptor();
            ...
            final RenderedImageFactory rif = new AffineCRIF();
    ...
    private static final Class[] paramClasses = {
        ...
        double[].class, ROI.class
    };

    /** The parameter name list for this operation. */
    private static final String[] paramNames = {
        "transform", "interpolation", "backgroundValues", "ROI"
    };
