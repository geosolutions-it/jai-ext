/*
 * $RCSfile: ROIAwareWarpGeneralOpImage.java,v $
 *
...
final class ROIAwareWarpGeneralOpImage extends ROIAwareWarpOpImage {
     ...
     */
    public ROIAwareWarpGeneralOpImage(RenderedImage source,
