        ...
        if(opNode instanceof RenderedOp &&
           name.equalsIgnoreCase("roi")) {
            ...
            if (interp instanceof InterpolationBilinear) {
	            ...
	            // input image.
//	            if (interp instanceof InterpolationBilinear){ 
	            	roiImage = new ScaleBilinearOpImage(constantImage, extender, scalingHints, null, sx, sy, tx, ty, interp, false);
//	            } else {
...
public class ScaleDescriptor extends OperationDescriptorImpl {
    ...
    private static final Object[] paramDefaults = {
        ...
        Interpolation.getInstance(Interpolation.INTERP_NEAREST),null, false
    };
    ...
    public static final boolean register() {
        ...
        try {
            final OperationDescriptor op = new ScaleDescriptor();
            ...
            final RenderedImageFactory rif = new ScaleCRIF();
            registry.registerFactory(RenderedRegistryMode.MODE_NAME, descName,"org.geotools.image", rif);
            return true;
        } catch (Exception e) {
