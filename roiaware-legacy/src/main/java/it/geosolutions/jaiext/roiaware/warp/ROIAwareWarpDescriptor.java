/*
 * $RCSfile: ROIAwareWarpDescriptor.java,v $
 *
        ...
        if(opNode instanceof RenderedOp &&
           name.equalsIgnoreCase("roi")) {
            ...
            if (interp instanceof InterpolationBilinear){ 
            	roiImage = new ROIAwareWarpBilinearOpImage(
            			constantImage, extender, warpingHints, null, warp, interp, null, srcROI);
            } else {
            	roiImage = new ROIAwareWarpNearestOpImage(
            			constantImage, warpingHints, null, warp, interp, null, srcROI);
            }
 ...
 * <tr><td>DocURL</td>      <td>http://java.sun.com/products/java-media/jai/forDevelopers/jai-apidocs/javax/media/jai/operator/ROIAwareWarpDescriptor.html</td></tr>
 ...
 */
public class ROIAwareWarpDescriptor extends OperationDescriptorImpl {
    
    private final static Logger LOGGER = Logger.getLogger(ROIAwareWarpDescriptor.class.toString());
    ...
    public static final boolean register() {
        ...
        try {
            final OperationDescriptor op = new ROIAwareWarpDescriptor();
            ...
            final RenderedImageFactory rif = new ROIAwareWarpRIF();
            registry.registerFactory(RenderedRegistryMode.MODE_NAME, descName,"it.geosolutions.jaiext.roiaware", rif);
            return true;
        } catch (Exception e) {
    ...
    private static final String[][] resources = {
        {"GlobalName",  "Warp"},
        {"LocalName",   "Warp"},
        {"Vendor",      "org.geotools.image"},
        {"Description", JaiI18N.getString("WarpDescriptor0")},
        {"DocURL",      "http://java.sun.com/products/java-media/jai/forDevelopers/jai-apidocs/javax/media/jai/operator/ROIAwareWarpDescriptor.html"},
