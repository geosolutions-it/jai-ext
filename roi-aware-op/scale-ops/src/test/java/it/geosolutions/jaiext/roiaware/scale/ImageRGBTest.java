...
public class ImageRGBTest<T extends Number & Comparable<? super T>> extends TestBase<T> {
    ...
    public void testInterpolation() {
        ...
        try {
            ...
            File inputFile = new File(
                    "C:/work/code/jai-ext/roi-aware-op/scale-ops/"
                            + "src/test/resources/it/geosolutions/jaiext/roiaware/scale/testImageLittle.tif");
