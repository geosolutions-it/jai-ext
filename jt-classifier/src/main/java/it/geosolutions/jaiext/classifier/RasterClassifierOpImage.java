...
/**
 * This class provides a few initialization method used for implementing the
 * RasterClassier operation, which is an extension of the GenericPiecewise one.
 * 
...
public class RasterClassifierOpImage<T extends ColorMapTransformElement>
	...
	public RasterClassifierOpImage(RenderedImage image,
		...
		super(image, lic, prepareLayout(image, layout, lic), bandIndex, roi,
				nodata, prepareHints(hints));
		this.isByteData = false;
	}

	/**
	 * Prepare the {@link RenderingHints} for the final image disabling direct
	 * colormap operations
	 * 
	 * @param hints
	 *            The {@link RenderingHints} used in the operation
	 * @return a {@link RenderingHints} object with a key for disabling Colormap
	 *         operations
	 */
	...
	private static <T extends ColorMapTransformElement> ImageLayout prepareLayout(
		...
		final SampleModel finalSampleModel = lic.getSampleModel(
