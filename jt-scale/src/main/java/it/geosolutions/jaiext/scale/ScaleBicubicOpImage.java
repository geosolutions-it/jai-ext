...
public class ScaleBicubicOpImage extends ScaleOpImage {
    ...
    public ScaleBicubicOpImage(RenderedImage source, ImageLayout layout, Map configuration,
        ...
        super(source, layout, configuration, true, extender, ((InterpolationBicubicNew) interp)
                .getInterpBiCubic(), scaleX, scaleY, transX, transY, useRoiAccessor);
    ...
    private void scaleOpInitialization(RenderedImage source, Interpolation interp) {
        ...
        if (interpolator instanceof InterpolationBicubicNew) {
                        ...
                        for (int j = 0; j < dheight; j++) {
                            ...
                            for (int i = 0; i < dwidth; i++) {
                                ...
                                if (temp == 0) {
                                    ...
                                    for (int h = 0; h < 4; h++) {
                                        // Update of the temporary sum
                                        sum += sumArray[h] * (long) dataVi[offsetY + h];
                                    }
    ...
    private void ushortLoop(RasterAccessor srcAccessor, Rectangle destRect,
            RasterAccessor dstAccessor, int[] xpos, int[] ypos, int[] xfracValues,
            int[] yfracValues, RasterAccessor roiAccessor, int[] yposRoi, int roiScanlineStride) {
        // TODO Auto-generated method stub

    }

    private void shortLoop(RasterAccessor srcAccessor, Rectangle destRect,
            RasterAccessor dstAccessor, int[] xpos, int[] ypos, int[] xfracValues,
            int[] yfracValues, RasterAccessor roiAccessor, int[] yposRoi, int roiScanlineStride) {
        // TODO Auto-generated method stub
    ...
    private void intLoop(RasterAccessor srcAccessor, Rectangle destRect,
            RasterAccessor dstAccessor, int[] xpos, int[] ypos, int[] xfracValues,
            int[] yfracValues, RasterAccessor roiAccessor, int[] yposRoi, int roiScanlineStride) {
        // TODO Auto-generated method stub
    ...
    private void floatLoop(RasterAccessor srcAccessor, Rectangle destRect,
            RasterAccessor dstAccessor, int[] xpos, int[] ypos, float[] xfracValuesFloat,
            float[] yfracValuesFloat, RasterAccessor roiAccessor, int[] yposRoi,
            int roiScanlineStride) {
        // TODO Auto-generated method stub

    }

    private void doubleLoop(RasterAccessor srcAccessor, Rectangle destRect,
            RasterAccessor dstAccessor, int[] xpos, int[] ypos, float[] xfracValuesFloat,
            float[] yfracValuesFloat, RasterAccessor roiAccessor, int[] yposRoi,
            int roiScanlineStride) {
        // TODO Auto-generated method stub
