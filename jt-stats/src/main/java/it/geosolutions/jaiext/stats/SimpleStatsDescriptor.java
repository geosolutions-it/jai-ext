 ...
 * This method checks if the ROI is present and if so, its bounds are intersected with the source images bounds,
...
/**
 * An <code>OperationDescriptor</code> describing various "Statistical" operation.
 * 
 * <p>
 ...
 * 
 * <p>
 * The source can have all the possible JAI accepted data types. The statistical calculations are performed on every tile and stored inside an
 * object which is a subclass of the "Statistics" class. For avoiding concurrency issues, the statistic accumulation performed after every tile
 * calculation, is done in a synchronized block. The statistical results are returned by calling the getProperty() method. The statistics are calculated
 * only the first time for avoiding unnecessary calculations. With this technique an advantage is taken by using the internal JAI MultiThreading.
 * </p>
 * 
 * <p>
 * When the results are returned by the getProperty() method as a 2-D array, the user must only select the first index related to one band and the second
 * index related to a specific computation, as defined at the image creation, and then calling the getResult() method.
 * </p>
 * 
 * 
 * <p><table border=1>
 ...
 * <tr><td>GlobalName</td>  <td>SimpleStats</td></tr>
 * <tr><td>LocalName</td>   <td>SimpleStats</td></tr>
 * <tr><td>Vendor</td>      <td>it.geosolutions.jaiext.roiaware</td></tr>
 * <tr><td>Description</td> <td>Image operator for calculating simple image statistics like mean supporting ROI and No Data.</td></tr>
 * <tr><td>DocURL</td>      <td>Not Defined</td></tr>
 * <tr><td>Version</td>     <td>1.0</td></tr>
 * <tr><td>arg0Desc</td>    <td>Horizontal subsampling parameter.</td></tr>
 * <tr><td>arg1Desc</td>    <td>Vertical subsampling parameter.</td></tr>
 * <tr><td>arg2Desc</td>    <td>ROI object used.</td></tr>
 * <tr><td>arg3Desc</td>    <td>No Data Range used.</td></tr>
 * <tr><td>arg4Desc</td>    <td>Boolean checking if ROI RasterAccessor is used.</td></tr>
 * <tr><td>arg5Desc</td>    <td>Array containing the indexes of the bands to calculate.</td></tr>
 * <tr><td>arg6Desc</td>    <td>Array indicating which statistical operations must be performed on all the selected bands.</td></tr>
 * </table></p>
 *
 * <p><table border=1>
 ...
 * <tr><td>xPeriod</td>     <td>Integer</td>
 *                            <td>1</td>
 * <tr><td>yPeriod</td> <td>Integer</td>
 *                            <td>1</td>
 ...
 *                            <td>False</td>    
 * <tr><td>bands</td> <td>int[]</td>
 *                            <td>null</td>     
 * <tr><td>stats</td> <td>it.geosolutions.jaiext.stats.Statistics.StatsType[]</td>
 *                            <td>null</td>                                                                  
 * </table></p>
 * 
 */
